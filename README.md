...
4. **Efectos visuales y animaciones**:
   - Animación de destrucción de la nave.
...
2. En el menú principal, selecciona "Iniciar" para comenzar.
3. Controla la nave para esquivar meteoritos y dispara para destruirlos.
4. Intenta sobrevivir durante el tiempo límite para ganar.
5. Si pierdes todas tus vidas, aparecerá la pantalla de "Game Over".
...
- **`preload()`**:
  Carga los recursos gráficos necesarios (imágenes del fondo, la nave y los meteoritos) antes de iniciar el juego.
...
- **`mostrarMenu()`**:
  Renderiza el menú principal y muestra los botones para iniciar el juego o ver los créditos.
